				...
				<form encType="multipart/form-data" action="register.cgi" method="post">
					...
					<div className="col-xs-6">
						<div className="form-group" style="display:none">
							...
							<input type="hidden" name="email" className="form-control" onChange={this.change_handle} ref="email" defaultValue={this.props.email}/>
						...
						<div className="form-group">
							...
							<input type="text" name="username" className="form-control" onChange={this.change_handle} ref="username" defaultValue={this.props.username}/>
						...
						<div className="form-group">
							...
							<input type="text" name="full_name" className="form-control" onChange={this.change_handle} ref="full_name" defaultValue={this.props.full_name} />
						...
						<div className="form-group">
							...
							<input type="password" name="password" className="form-control" onChange={this.change_handle} ref="password" defaultValue={this.props.password}/>
							{(
						...
						<div className="form-group">
							...
							<input type="password" className="form-control" onChange={this.change_handle} ref="confirm_password" defaultValue={this.props.password} />
							{(
					...
					<div className="col-xs-6">
						...
						<div className="form-group">
							...
							<input type="text" name="longitude" className="form-control" onChange={this.change_handle} ref="longitude" defaultValue={this.porps.longitude} />
							{(
						...
						<div className="form-group">
							...
							<input type="text" name="latitude" className="form-control" onChange={this.change_handle} ref="latitude" defaultValue={this.props.latitude}/>
							{(
						...
						<div className="form-group">
							<label>Suburb</label>
							<input type="text" name="suburb" className="form-control" onChange={this.change_handle} ref="suburb" defaultValue={this.props.suburb} />
							{(
						...
						<div className="form-group">
							...
							<textarea name="self_intro" className="form-control" rows="3" defaultValue={this.props.status}/>
							{(
					...
					<input type="hidden" value={this.props.UID}/>
					<input type="hidden" value={this.props.listens}/>
					<input type="hidden" value={this.props.bleats}/>
