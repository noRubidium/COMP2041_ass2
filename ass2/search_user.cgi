...
try:
	...
	if login_validate.validate(cookie["logged_in"].value):
		...
		if 'username' in form.keys():
			# print the page including the search result of the user with their recent bleat
			...
			print open(base+"user_search.html").read().format(string,"Search result for '"+username_s+"'")
