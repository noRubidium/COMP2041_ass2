...
def my_account_menu(username,password):
	return '''<form method = "POST" action = "cgi/Logout.cgi"><li><a href="#">Dashboard</a></li>
            <li><button type = "submit" action="Logout">Logout</button></li></form>'''.format(username,password)
